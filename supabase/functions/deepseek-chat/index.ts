...
print(result)`,
    ...
    return {
      content: `Hello! I'm your Deepseek Chat assistant. I can help with various tasks including running Python code, data analysis, and general assistance. How can I help you today?`,
      executive: "Eliza",
      status: "success", 
      provider: "deepseek",
      model: "deepseek-chat",
...
serve(async (req) => {
  console.log(`deepseek-chat - ${req.method} request received`);
...
// Log startup
console.log(`deepseek-chat started successfully - Enhanced with robust error handling`);